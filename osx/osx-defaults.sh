...
defaults write NSGlobalDomain NSLinguisticDataAssetsRequested -array "en_US" "it"
...
tell application "Terminal"
    ...
    do shell script "open '$HOME/dotfiles/misc/" & themeName & ".terminal'"
...
open "${HOME}/dotfiles/misc/Solarized Dark.itermcolors"
...
# Prevent Photos from opening automatically when devices are plugged in
defaults write -app "Firefox" PMPrintingExpandedStateForPrint2 -bool false
